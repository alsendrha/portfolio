          ...
          <div>
            <div className="flex flex-col justify-center items-center">
              ...
              <div className="flex relative -top-[24px] max-[925px]:flex-col max-[925px]:items-start">
                <div className="flex flex-col justify-start items-end relative right-[60px] max-[980px]:right-[20px] max-[925px]:right-0">
                  <h2 className="text-[50px] leading-none font-bold text-[#21277b]">
                    2021 ~ 22
                  </h2>
                  <h2 className="text-[24px] text-[#5f83b1]">12.08 ~ 06.07</h2>
                </div>
                <div className="flex flex-col mt-1 justify-start items-start relative left-[130px] max-[980px]:left-[90px] max-[925px]:left-0">
            ...
            <div className="flex flex-col justify-center items-center mt-20">
              ...
              <div className="flex relative -top-[24px] max-[925px]:flex-col-reverse max-[925px]:items-start">
                <div className="flex flex-col mt-1 justify-start items-end max-[925px]:items-start relative right-[110px] max-[980px]:right-[70px] max-[925px]:right-0">
                  <p className="font-bold">이블루(주) 입사</p>
                  <p>android앱 개발</p>
                  <p>회사 경영악화로 권고사직</p>
                  <p>(현재 회사 폐업)</p>
                </div>
                <div className="flex flex-col justify-start items-start relative left-[80px] max-[980px]:left-[40px] max-[925px]:left-0">
                  <h2 className="text-[50px] leading-none font-bold text-[#21277b]">
                    2022
                  </h2>
            ...
            <div className="flex flex-col justify-center items-center mt-20">
              <div className="flex items-center justify-center w-[15px] h-[15px] rounded-full bg-black max-[925px]:bg-gray-300"></div>
              <div className="flex relative -top-[24px] max-[925px]:flex-col-reverse max-[925px]:items-start">
                <div className="flex flex-col mt-1 justify-start items-end max-[925px]:items-start relative right-[120px] max-[980px]:right-[80px] max-[925px]:right-0">
                ...
                <div className="flex flex-col justify-start items-start relative left-[70px] max-[980px]:left-[30px] max-[925px]:left-0">
                  <h2 className="text-[50px] leading-none font-bold text-[#21277b]">
                    2023
                  </h2>
            ...
            <div className="flex flex-col justify-center items-center mt-20">
              <div className="flex items-center justify-center w-[15px] h-[15px] rounded-full bg-black max-[925px]:bg-gray-300"></div>
              <div className="flex relative -top-[24px] max-[925px]:flex-col max-[925px]:items-start">
                <div className="flex flex-col justify-start items-end relative right-[70px] max-[980px]:right-[30px] max-[925px]:right-0">
                  <h2 className="text-[50px] leading-none font-bold text-[#21277b]">
                    2023
                  </h2>
                  <h2 className="text-[24px] text-[#5f83b1]">09.01 ~ 10.31</h2>
                </div>
                <div className="flex flex-col mt-1 justify-start items-start relative left-[115px] max-[980px]:left-[75px] max-[925px]:left-0">
            ...
            <div className="flex flex-col justify-center items-center mt-20">
              <div className="flex items-center justify-center w-[15px] h-[15px] rounded-full bg-black max-[925px]:bg-gray-300"></div>
              <div className="flex relative -top-[24px] max-[925px]:flex-col-reverse max-[925px]:items-start">
                <div className="flex flex-col mt-1 justify-start items-end max-[925px]:items-start relative right-[85px] max-[980px]:right-[45px] max-[925px]:right-0">
                ...
                <div className="flex flex-col justify-start items-start relative left-[105px] max-[980px]:left-[65px] max-[925px]:left-0">
                  <h2 className="text-[50px] leading-none font-bold text-[#21277b]">
                    2023 ~ 24
                  </h2>
